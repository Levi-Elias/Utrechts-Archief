...
<div class="panorama">
    <div class="info-container">
                    ...
                    foreach ($hotspotsarray as $hotspot) {
                            ...
                            ?>
                            <div class="hotspot-marker" style="left: <?php echo $left; ?>px; top: <?php echo $top; ?>px;">
            ...
            <img src="img/3.jpg" alt="Panorama Image 3"
                style="height: 497.5px; z-index: 1; margin-left: -40px; margin-top: -1px;">
            <img src="img/4.jpg" alt="Panorama Image 4"
                style="height: 500px; z-index: 1; margin-left: -43px; margin-top: -5px;">
            <img src="img/5.jpg" alt="Panorama Image 5"
                style="height: 506px; z-index: 1; margin-left: -56px; margin-top: -8px;">
            <img src="img/6.jpg" alt="Panorama Image 6""
                style="height: 511px; z-index: 1; margin-left: -60px; margin-top: -12px;">
            <img src="img/7.jpg" alt="Panorama Image 7"
                style="height: 523px; z-index: 1; margin-left: -71px; margin-top: -13px;">
            <img src="img/8.jpg" alt="Panorama Image 8"
                style="height: 502px; z-index: 1; margin-left: -44px; margin-top: -6px;">
            <img src="img/9.jpg" alt="Panorama Image 9"
                style="height: 514px; z-index: 1; margin-left: -37px; margin-top: -12px;">
            <img src="img/10.jpg" alt="Panorama Image 10"
                style="height: 511px; z-index: 1; margin-left: -44px; margin-top: -11px;">
            <img src="img/11.jpg" alt="Panorama Image 11"
                style="height: 515px; z-index: 1; margin-left: -62px; margin-top: -13px;">
            <img src="img/12.jpg" alt="Panorama Image 12"
                style="height: 518px; z-index: 1; margin-left: -60px; margin-top: -11px;">
            <img src="img/13.jpg" alt="Panorama Image 13"
                style="height: 515.5px; z-index: 1; margin-left: -37px; margin-top: -11px;">
            <img src="img/14.jpg" alt="Panorama Image 14"
                style="height: 509px; z-index: 1; margin-left: -45px; margin-top: -6px;">
            <img src="img/15.jpg" alt="Panorama Image 15"
                style="height: 506px; z-index: 1; margin-left: -59px; margin-top: -4px;">
            <img src="img/16.jpg" alt="Panorama Image 16"
                style="height: 505px; z-index: 1; margin-left: -54px; margin-top: 1px;">
            <img src="img/17.jpg" alt="Panorama Image 17"
                style="height: 508px; z-index: 1; margin-left: -36px; margin-top: 1px;">
            <img src="img/18.jpg" alt="Panorama Image 18"
                style="height: 515px; z-index: 1; margin-left: -40px; margin-top: 1.5px;">
            <img src="img/19.jpg" alt="Panorama Image 19"
                style="height: 526px; z-index: 1; margin-left: -41px; margin-top: -3px;">
            <img src="img/20.jpg" alt="Panorama Image 20"
                style="height: 534px; z-index: 1; margin-left: -38px; margin-top: -6px;">
            <img src="img/21.jpg" alt="Panorama Image 21"
                style="height: 526px; z-index: 1; margin-left: -30px; margin-top: 7px;">
            <img src="img/22.jpg" alt="Panorama Image 22"
                style="height: 542px; z-index: 1; margin-left: -43px; margin-top: -5px;">
            <img src="img/23.jpg" alt="Panorama Image 23"
                style="height: 528px; z-index: 1; margin-left: -40px; margin-top: 2px;">
            <img src="img/24.jpg" alt="Panorama Image 24"
                style="height: 506px; z-index: 1; margin-left: -34px; margin-top: 16px;">
            <img src="img/25.jpg" alt="Panorama Image 25"
                style="height: 524px; z-index: 1; margin-left: -30px; margin-top: 1px;">
            <img src="img/26.jpg" alt="Panorama Image 26"
                style="height: 510.5px; z-index: 1; margin-left: -35px; margin-top: 12px;">
            <img src="img/27.jpg" alt="Panorama Image 27"
                style="height: 527px; z-index: 1; margin-left: -42px; margin-top: 5px;">
            <img src="img/28.jpg" alt="Panorama Image 28"
                style="height: 540px; z-index: 1; margin-left: -48px; margin-top: -4px;">
            <img src="img/29.jpg" alt="Panorama Image 29"
                style="height: 534px; z-index: 1; margin-left: -44px; margin-top: -1px;">
            <img src="img/30.jpg" alt="Panorama Image 30"
                style="height: 531px; z-index: 1; margin-left: -53px; margin-top: 5px;">
            <img src="img/31.jpg" alt="Panorama Image 31"
                style="height: 540px; z-index: 1; margin-left: -47px; margin-top: 1px;">
            <img src="img/32.jpg" alt="Panorama Image 32"
                style="height: 535px; z-index: 1; margin-left: -48px; margin-top: -4px;">
            <img src="img/33.jpg" alt="Panorama Image 33"
                style="height: 539px; z-index: 1; margin-left: -45px; margin-top: -2px;">
        </div>
